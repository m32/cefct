...
cefsizesok &= cefchecksize("cef_browser_process_handler_t", cef_browser_process_handler_t, 72)
...
cefsizesok &= cefchecksize("cef_request_handler_t", cef_request_handler_t, 120)
...
cefsizesok &= cefchecksize("cef_v8value_t", cef_v8value_t, 416)
...
cefsizesok &= cefchecksize("cef_pdf_print_settings_t", cef_pdf_print_settings_t, 96)
