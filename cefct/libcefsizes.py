...
cefsizesok &= cefchecksize("cef_browser_host_t", cef_browser_host_t, 584)
cefsizesok &= cefchecksize("cef_browser_process_handler_t", cef_browser_process_handler_t, 96)
cefsizesok &= cefchecksize("cef_browser_t", cef_browser_t, 208)
cefsizesok &= cefchecksize("cef_browser_view_delegate_t", cef_browser_view_delegate_t, 192)
cefsizesok &= cefchecksize("cef_browser_view_t", cef_browser_view_t, 488)
cefsizesok &= cefchecksize("cef_button_delegate_t", cef_button_delegate_t, 144)
cefsizesok &= cefchecksize("cef_button_t", cef_button_t, 504)
...
cefsizesok &= cefchecksize("cef_frame_handler_t", cef_frame_handler_t, 80)
cefsizesok &= cefchecksize("cef_frame_t", cef_frame_t, 248)
...
cefsizesok &= cefchecksize("cef_label_button_t", cef_label_button_t, 592)
cefsizesok &= cefchecksize("cef_layout_t", cef_layout_t, 64)
cefsizesok &= cefchecksize("cef_life_span_handler_t", cef_life_span_handler_t, 88)
...
cefsizesok &= cefchecksize("cef_menu_button_delegate_t", cef_menu_button_delegate_t, 152)
cefsizesok &= cefchecksize("cef_menu_button_pressed_lock_t", cef_menu_button_pressed_lock_t, 40)
cefsizesok &= cefchecksize("cef_menu_button_t", cef_menu_button_t, 608)
...
cefsizesok &= cefchecksize("cef_panel_delegate_t", cef_panel_delegate_t, 128)
cefsizesok &= cefchecksize("cef_panel_t", cef_panel_t, 552)
...
cefsizesok &= cefchecksize("cef_request_context_t", cef_request_context_t, 248)
cefsizesok &= cefchecksize("cef_request_handler_t", cef_request_handler_t, 128)
...
cefsizesok &= cefchecksize("cef_scroll_view_t", cef_scroll_view_t, 512)
...
cefsizesok &= cefchecksize("cef_task_manager_t", cef_task_manager_t, 80)
cefsizesok &= cefchecksize("cef_task_runner_t", cef_task_runner_t, 80)
cefsizesok &= cefchecksize("cef_task_t", cef_task_t, 48)
cefsizesok &= cefchecksize("cef_textfield_delegate_t", cef_textfield_delegate_t, 144)
cefsizesok &= cefchecksize("cef_textfield_t", cef_textfield_t, 704)
cefsizesok &= cefchecksize("cef_thread_t", cef_thread_t, 72)
cefsizesok &= cefchecksize("cef_unresponsive_process_callback_t", cef_unresponsive_process_callback_t, 56)
...
cefsizesok &= cefchecksize("cef_view_delegate_t", cef_view_delegate_t, 128)
cefsizesok &= cefchecksize("cef_view_t", cef_view_t, 456)
cefsizesok &= cefchecksize("cef_waitable_event_t", cef_waitable_event_t, 80)
cefsizesok &= cefchecksize("cef_window_delegate_t", cef_window_delegate_t, 312)
cefsizesok &= cefchecksize("cef_window_t", cef_window_t, 888)
...
cefsizesok &= cefchecksize("cef_linux_window_properties_t", cef_linux_window_properties_t, 96)
...
cefsizesok &= cefchecksize("cef_task_info_t", cef_task_info_t, 80)
...
cefsizesok &= cefchecksize("cef_accelerated_paint_info_common_t", cef_accelerated_paint_info_common_t, 104)
cefsizesok &= cefchecksize("cef_main_args_t", cef_main_args_t, 16)
cefsizesok &= cefchecksize("cef_window_info_t", cef_window_info_t, 80)
cefsizesok &= cefchecksize("cef_accelerated_paint_native_pixmap_plane_t", cef_accelerated_paint_native_pixmap_plane_t, 32)
cefsizesok &= cefchecksize("cef_accelerated_paint_info_t", cef_accelerated_paint_info_t, 256)
assert cefsizesok == 1
