...
class cef_app_t(Structure):
    ...
    def __init__(self):
        ...
        self._callbacks = [
            ...
            CEFCALLBACK(POINTER(None), POINTER(cef_app_t))(self.GetResourceBundleHandler),
            CEFCALLBACK(POINTER(None), POINTER(cef_app_t))(self.GetBrowserProcessHandler),
            CEFCALLBACK(POINTER(None), POINTER(cef_app_t))(self.GetRenderProcessHandler),
        ]
...
class cef_browser_process_handler_t(Structure):
    ...
    def __init__(self):
        ...
        self._callbacks = [
            ...
            CEFCALLBACK(POINTER(None), POINTER(cef_browser_process_handler_t))(self.GetDefaultClient),
        ]
...
class cef_client_t(Structure):
    ...
    def __init__(self):
        ...
        self._base.size = sizeof(self)
        self._callbacks = [
            CEFCALLBACK(POINTER(None), POINTER(cef_client_t))(self.GetAudioHandler),
            CEFCALLBACK(POINTER(None), POINTER(cef_client_t))(self.GetCommandHandler),
            CEFCALLBACK(POINTER(None), POINTER(cef_client_t))(self.GetContextMenuHandler),
            CEFCALLBACK(POINTER(None), POINTER(cef_client_t))(self.GetDialogHandler),
            CEFCALLBACK(POINTER(None), POINTER(cef_client_t))(self.GetDisplayHandler),
            CEFCALLBACK(POINTER(None), POINTER(cef_client_t))(self.GetDownloadHandler),
            CEFCALLBACK(POINTER(None), POINTER(cef_client_t))(self.GetDragHandler),
            CEFCALLBACK(POINTER(None), POINTER(cef_client_t))(self.GetFindHandler),
            CEFCALLBACK(POINTER(None), POINTER(cef_client_t))(self.GetFocusHandler),
            CEFCALLBACK(POINTER(None), POINTER(cef_client_t))(self.GetFrameHandler),
            CEFCALLBACK(POINTER(None), POINTER(cef_client_t))(self.GetJSDialogHandler),
            CEFCALLBACK(POINTER(None), POINTER(cef_client_t))(self.GetKeyboardHandler),
            CEFCALLBACK(POINTER(None), POINTER(cef_client_t))(self.GetLifeSpanHandler),
            CEFCALLBACK(POINTER(None), POINTER(cef_client_t))(self.GetLoadHandler),
            CEFCALLBACK(POINTER(None), POINTER(cef_client_t))(self.GetPrintHandler),
            CEFCALLBACK(POINTER(None), POINTER(cef_client_t))(self.GetRenderHandler),
            CEFCALLBACK(POINTER(None), POINTER(cef_client_t))(self.GetRequestHandler),
...
cef_app_t._fields_ = (
    ...
    ('_get_resource_bundle_handler', CEFCALLBACK(POINTER(None), POINTER(cef_app_t))),
    ('_get_browser_process_handler', CEFCALLBACK(POINTER(None), POINTER(cef_app_t))),
    ('_get_render_process_handler', CEFCALLBACK(POINTER(None), POINTER(cef_app_t))),
)
...
cef_browser_process_handler_t._fields_ = (
    ...
    ('_get_default_client', CEFCALLBACK(POINTER(None), POINTER(cef_browser_process_handler_t))),
)
...
cef_client_t._fields_ = (
    ('_base', cef_base_ref_counted_t),
    ('_get_audio_handler', CEFCALLBACK(POINTER(None), POINTER(cef_client_t))),
    ('_get_command_handler', CEFCALLBACK(POINTER(None), POINTER(cef_client_t))),
    ('_get_context_menu_handler', CEFCALLBACK(POINTER(None), POINTER(cef_client_t))),
    ('_get_dialog_handler', CEFCALLBACK(POINTER(None), POINTER(cef_client_t))),
    ('_get_display_handler', CEFCALLBACK(POINTER(None), POINTER(cef_client_t))),
    ('_get_download_handler', CEFCALLBACK(POINTER(None), POINTER(cef_client_t))),
    ('_get_drag_handler', CEFCALLBACK(POINTER(None), POINTER(cef_client_t))),
    ('_get_find_handler', CEFCALLBACK(POINTER(None), POINTER(cef_client_t))),
    ('_get_focus_handler', CEFCALLBACK(POINTER(None), POINTER(cef_client_t))),
    ('_get_frame_handler', CEFCALLBACK(POINTER(None), POINTER(cef_client_t))),
    ('_get_jsdialog_handler', CEFCALLBACK(POINTER(None), POINTER(cef_client_t))),
    ('_get_keyboard_handler', CEFCALLBACK(POINTER(None), POINTER(cef_client_t))),
    ('_get_life_span_handler', CEFCALLBACK(POINTER(None), POINTER(cef_client_t))),
    ('_get_load_handler', CEFCALLBACK(POINTER(None), POINTER(cef_client_t))),
    ('_get_print_handler', CEFCALLBACK(POINTER(None), POINTER(cef_client_t))),
    ('_get_render_handler', CEFCALLBACK(POINTER(None), POINTER(cef_client_t))),
    ('_get_request_handler', CEFCALLBACK(POINTER(None), POINTER(cef_client_t))),
