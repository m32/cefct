...
class Parser(object):
    def __init__(self, ceftop):
        ...
        self.versions = {
            'CEF_VERSION': None,
            'CEF_VERSION_MAJOR': None,
            'CEF_VERSION_MINOR': None,
            'CEF_VERSION_PATCH': None,
            'CEF_COMMIT_NUMBER': None,
            'CEF_COMMIT_HASH': None,
            'CHROME_VERSION_MAJOR': None,
            'CHROME_VERSION_MINOR': None,
            'CHROME_VERSION_BUILD': None,
            'CHROME_VERSION_PATCH': None,
        }
    ...
    def parseVersion(self, fname):
        ...
        for line in lines:
            if line.find('#define ')==0:
                ...
                if line[1] in self.versions:
                    self.versions[line[1]] = line[2]
...
""".format(
    ...
    def getfiles(self):
        ...
        for fname in sorted(fnames):
            ...
            self.parseFile(fqname)
        self.parseVersion(os.path.join(self.ceftop, "include/cef_version.h"))
        self.parseDecl()
        self.parseSizes()
