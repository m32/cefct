...
libcef_path = "Interop/"
libcef_filename = "libcef.py"
libcef_version_filename = "libcefversion.py"
...
c2cs_types = {
    ...
    "cef_string_userfree_t": "POINTER(cef_string_userfree_t)",
    "cef_string_list_t": "cef_string_list_t",
    "cef_string_map_t": "cef_string_map_t",
    "cef_string_multimap_t": "cef_string_multimap_t",
    "time_t": "c_int",
    "cef_window_handle_t": "c_void_p",
    "cef_event_handle_t": "c_void_p",
    "cef_cursor_handle_t": "c_void_p",
...
def c2cs_type(ctype):
    ...
    if ctype in c2cs_types:
        ...
        sys.stdout.write(
            'Warning! C type "%s" is not mapped to C# type (processed to "%s").\n'
            % (warn_ctype, ctype)
        )
        ret = ctype
